...
class MyMask implements TextInputFormatter {
  ...
  String maskText(String text) {
    return MyMask(mask: _mask, filter: _maskFilter, initialText: text).getMaskedText();
  }

  /// Unmask some text
  String unmaskText(String text) {
    return MyMask(mask: _mask, filter: _maskFilter, initialText: text).getUnmaskedText();
  }
